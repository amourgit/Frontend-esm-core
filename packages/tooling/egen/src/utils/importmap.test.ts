...
describe('proxyImportmapAndRoutes', () => {
  ...
  const backend = 'https://dev3.egen.org';
    ...
    const input: ImportmapAndRoutesWithWatches = {
      importMap: {
        ...
        value: JSON.stringify({
          imports: {
            '@egen/foo': 'https://dev3.egen.org/egen/spa/foo-1.0.0/foo.js',
          },
        }),
      },
      routes: { type: 'inline', value: '{}' },
      ...
      importMap: {
        ...
        value: JSON.stringify({
          imports: {
            ...
            '@egen/remote': 'https://dev3.egen.org/egen/spa/remote.js',
          },
        }),
      },
      routes: { type: 'inline', value: '{}' },
  ...
  it('handles URLs with search params and hash fragments', () => {
    const input: ImportmapAndRoutesWithWatches = {
      importMap: {
        ...
        value: JSON.stringify({
          imports: {
            '@egen/foo': 'https://dev3.egen.org/egen/spa/foo.js?v=1#section',
          },
        }),
      },
      routes: { type: 'inline', value: '{}' },
