...
import type { ExtensionInternalStore } from '@egen-civitas/esm-framework/src/internal';
import { getExtensionInternalStore } from '@egen-civitas/esm-framework/src/internal';
