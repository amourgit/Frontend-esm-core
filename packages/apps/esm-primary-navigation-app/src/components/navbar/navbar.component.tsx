...
import {
  ...
  useLeftNavStore,
  useSession,
} from '@igen/esm-framework';
import { useTenantMode } from '@igen/esm-tenant';
      ...
      <Header aria-label={t('primaryNavigation', 'Navigation principale EIGEN')} className={styles.topNavHeader}>
        ...
        <HeaderGlobalBar className={styles.rightSection}>
          ...
          <ExtensionSlot
            ...
            state={{ isActivePanel, togglePanel }}
          />
...
// =============================================================================
//  NAVBAR — Composant racine
//  Gère l'affichage conditionnel selon l'état d'authentification et le mode tenant.
//  Voir la règle d'or dans use-tenant-routing.ts pour la coordination avec le Guard.
// =============================================================================
const Navbar: React.FC = () => {
  ...
  // Non connecté, mode single/off → la Navbar redirige
