...
const defaultSwrConfig: SWRConfiguration = {
  ...
  shouldRetryOnError: (error) => {
    if (error instanceof EgenFetchError) {
...
export interface EgenReactComponentProps {
  _extensionContext?: ExtensionData;
}

export interface EgenReactComponentState {
  caughtError: any;
  caughtErrorInfo: ErrorInfo | null;
  config: ComponentConfig;
}

export function egenComponentDecorator<T>(userOpts: ComponentDecoratorOptions) {
  if (
