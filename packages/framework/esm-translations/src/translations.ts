...
export const coreTranslations = {
  ...
  entityAvatarAlt: 'Avatar for {{entityName}}',
  entityGroups: 'Entity Groups',
  entityIdentifierSticker: 'Entity identifier sticker',
  entityPhotoAlt: 'Profile photo of {{entityName}}',
  entityPhotoPlaceholder: 'Photo placeholder for {{entityName}}',
  error: 'Error',
  errorCopy:
  ...
  seeAll: 'See all',
  seeMoreGroups: 'See {{count}} more groups',
