 ...
 */
export interface EgenDatePickerProps
...
const defaultProps: EgenDatePickerProps = {
  short: false,
  size: 'md',
};
 ...
 */
export const EgenDatePicker = /*#__PURE__*/ forwardRef<HTMLDivElement, EgenDatePickerProps>(
  function EgenDatePicker(props, ref) {
    const {
      className,
