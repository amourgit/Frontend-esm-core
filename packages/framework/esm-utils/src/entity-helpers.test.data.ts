...
export const mockEntityWithNoName = {
  ...mockEntity,
  name: [],
};

export const mockEntityWithMultipleNames = {
...
export const mockEntityWithOfficialName = {
  ...mockEntity,
  name: [
    {
...
export const mockEntityWithNickAndOfficialName = {
  ...mockEntity,
  name: [
    {
      id: 'id-of-nickname-1',
