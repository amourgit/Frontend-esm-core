/**
 * A test that validates that `@egen/esm-framework/mock` has
 * the same API as `@egen/esm-framework`.
 *
...
describe('@egen/esm-framework/mock', () => {
  it.skip('should have the same exports as @egen/esm-framework', () => {
