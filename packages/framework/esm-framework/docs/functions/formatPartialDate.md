...
Defined in: [packages/framework/esm-utils/src/dates/date-util.ts:241](https://github.com/egen/egen-esm-core/blob/main/packages/framework/esm-utils/src/dates/date-util.ts#L241)
