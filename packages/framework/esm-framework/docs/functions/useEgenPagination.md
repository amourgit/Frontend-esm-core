[O3 Framework](../API.md) / useEgenPagination

# Function: useEgenPagination()

> **useEgenPagination**\<`T`\>(`url`, `pageSize`, `options`): `object`
...
> **mutate**: `KeyedMutator`\<[`FetchResponse`](../interfaces/FetchResponse.md)\<`EgenPaginatedResponse`\<`T`\>\>\>
