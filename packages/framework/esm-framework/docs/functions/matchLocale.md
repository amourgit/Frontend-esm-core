...
Defined in: [packages/framework/esm-utils/src/match-locale.ts:53](https://github.com/egen/egen-esm-core/blob/main/packages/framework/esm-utils/src/match-locale.ts#L53)
