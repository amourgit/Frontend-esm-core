...
Defined in: [packages/framework/esm-context/src/context.ts:64](https://github.com/egen/egen-esm-core/blob/main/packages/framework/esm-context/src/context.ts#L64)
