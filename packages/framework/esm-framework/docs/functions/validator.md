...
Defined in: [packages/framework/esm-config/src/validators/validator.ts:25](https://github.com/egen/egen-esm-core/blob/main/packages/framework/esm-config/src/validators/validator.ts#L25)
