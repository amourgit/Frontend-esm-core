[O3 Framework](../API.md) / egenFetch

# Function: egenFetch()

> **egenFetch**\<`T`\>(`path`, `fetchInit`): `Promise`\<[`FetchResponse`](../interfaces/FetchResponse.md)\<`T`\>\>

Defined in: [packages/framework/esm-api/src/egen-fetch.ts:90](https://github.com/egen/egen-esm-core/blob/main/packages/framework/esm-api/src/egen-fetch.ts#L90)
