...
Defined in: [packages/framework/esm-config/src/module-config/module-config.ts:292](https://github.com/egen/egen-esm-core/blob/main/packages/framework/esm-config/src/module-config/module-config.ts#L292)
