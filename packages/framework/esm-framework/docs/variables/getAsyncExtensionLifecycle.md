...
Defined in: [packages/framework/esm-react-utils/src/getLifecycle.ts:84](https://github.com/egen/egen-esm-core/blob/main/packages/framework/esm-react-utils/src/getLifecycle.ts#L84)
