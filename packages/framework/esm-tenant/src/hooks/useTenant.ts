...
// ============================================================================
//
//  Les hooks suivent EXACTEMENT le même pattern que les hooks EIGEN existants :
//
//  - useFeatureFlag   → useStore(featureFlagsStore)
//  - useSession       → getSessionStore().subscribe(...)
//  - useTenant        → useStore(tenantStore)   ← ce fichier
//
//  Cela signifie que les apps peuvent aussi faire :
...
//
//  Les hooks de ce fichier sont des wrappers pratiques avec une API
//  plus expressive, mais ils restent de simples projections du store.
// ============================================================================
